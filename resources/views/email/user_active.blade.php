			...
			<table border="0" cellpadding="0" cellspacing="0" align="center"
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
						...
						<a target="_blank" style="text-decoration: none;"
							href="{{ route('home') }}"><img border="0" vspace="0" hspace="0"
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;  padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
						...
						Account Activation Email by MP-Resource
					</td>
				</tr>
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
				...
				<tr>
					<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
						...
						Your account at our MP-Resource Shop has been activated now. Use your own credentials to login your account to visit our site simply click on the Button below.
					</td>
				</tr>
				...
				<tr>
					<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400; line-height: 150%;
						...
						This email was sent to&nbsp;you because we&nbsp;want to&nbsp;make the&nbsp;world a&nbsp;better place. You&nbsp;can <a href="{{ route('home') }}" target="_blank" style="text-decoration: underline; color: #828999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">contact</a> with us at anytime if you want any assistance.<br/>
						© MP-Resource Shop Ltd. 2020
					</td>
				</tr>
			</table>
		</td></tr></table>
